...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://FREE_gf:FREE_gf@cluster0.xcn3xqi.mongodb.net/?retryWrites=true&w=majority")
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002021152965')
...
START_MESSAGE = environ.get("Hello User")
BUTTON_LOCK_TEXT = environ.get("BUTTON_LOCK_TEXT")
FORCE_SUB_TEXT = environ.get("Please Join My Update Channel After Click Try Again")

WELCOM_PIC = environ.get("WELCOM_PIC", "")
WELCOM_TEXT = environ.get("Hey Dear Friend")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'VANSH_00l')
